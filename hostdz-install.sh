...
sudo update-rc.d -f couchpotato remove >/dev/null 2>&1
mv /home/$1/.couchpotato /home/$1/.couchpotato_`date '+%m-%d-%Y_%H-%M'` >/dev/null 2>&1
echo '--->Any existing CouchPotato files were moved to /home/'$1'/.couchpotato_'`date '+%m-%d-%Y_%H-%M'`
echo
...
chmod 775 -R /home/$1/.couchpotato >/dev/null 2>&1
sudo chown $1: /home/$1/.couchpotato >/dev/null 2>&1
echo

echo '--->Creating new default and init scripts...'
sleep 2
cd /home/$1/.couchpotato/init
echo
...
sleep 1
echo "CP_HOME=/home/"$1"/.couchpotato/" >> couchpotato
echo "CP_DATA=/home/"$1"/.config/couchpotato" >> couchpotato
echo '--->Enabling current user ('$1') to run CouchPotato...'
echo "CP_USER="$1 >> couchpotato
###EDIT
echo "CP_PIDFILE=/home/"$1"/.pid/couchpotato.pid" >> couchpotato
...
sudo chown $1: /etc/init.d/couchpotato
